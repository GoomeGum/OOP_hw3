...
import Playable.Unit.Players.Hunter.Hunter;
import Playable.Unit.Players.Mage.Mage;
import Playable.Unit.Players.Player;
import Playable.Unit.Players.Rogue.Rogue;
import Playable.Unit.Players.Warrior.Warrior;
...
public class TileFactory {
    ...
    public Enemy produceEnemy(char tile, Position position) {
        Character c =tile;
        Enemy enemy = enemiesMap.get(c).get();
